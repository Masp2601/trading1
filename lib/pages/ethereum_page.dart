...
class EthhereumPage extends StatefulWidget {
  const EthhereumPage({Key? key}) : super(key: key);

  @override
  State<EthhereumPage> createState() => _EthhereumPageState();
}

class _EthhereumPageState extends State<EthhereumPage> {
  File? file;
